...
* [trackerjacker](https://github.com/calebmadrigal/trackerjacker) ⭐ 2,717 | 🐛 18 | 🌐 Python | 📅 2026-03-22 - Maps and tracks Wi-Fi networks and devices through raw 802.11 monitoring.

Wireless

* [WHAD](https://github.com/whad-team/whad-client) ⭐ 289 | 🐛 70 | 🌐 Python | 📅 2026-03-26 - A powerful framework to perform various kinds of Wireless attacks.

IPv6

* [mitm6](https://github.com/fox-it/mitm6) ⭐ 1,897 | 🐛 18 | 🌐 Python | 📅 2024-02-20 - Performs MiTM for IPv6.
...
* [Linux Kernel](https://github.com/torvalds/linux/blob/master/tools/testing/selftests/tc-testing/plugin-lib/scapyPlugin.py) ⭐ 225,369 | 🐛 3 | 🌐 C | 📅 2026-03-28 - Linux Traffic Control (tc) testing suite.
* [RIOT-OS](https://github.com/RIOT-OS/RIOT/search?l=Python\&q=scapy\&type=Code) ⭐ 5,702 | 🐛 834 | 🌐 C | 📅 2026-03-26 - RIOT OS networking testing suite.
...
* [pysap](https://github.com/SecureAuthCorp/pysap) ⭐ 244 | 🐛 10 | 🌐 Python | 📅 2024-12-04 - Interact with SAP using custom built frames & tools.
