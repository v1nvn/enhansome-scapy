...
* [pwnagotchi](https://github.com/evilsocket/pwnagotchi) ⭐ 8,930 | 🐛 295 | 🌐 Python | 📅 2025-08-23 - Your AI pet that hacks WiFI to grow. It's super cute.

DDoS

* [ufonet](https://github.com/epsylon/ufonet) ⭐ 2,422 | 🐛 2 | 🌐 JavaScript | 📅 2024-08-23 - Create your own botnet to send untraceable DDoS attacks.

Wi-Fi.

* [wifiphisher](https://github.com/wifiphisher/wifiphisher) ⭐ 14,405 | 🐛 348 | 🌐 Python | 📅 2025-02-04 - Create rogue access point.
...
* [WHAD](https://github.com/whad-team/whad-client) ⭐ 282 | 🐛 67 | 🌐 Python | 📅 2026-02-06 - A powerful framework to perform various kinds of Wireless attacks.

IPv6

* [mitm6](https://github.com/fox-it/mitm6) ⭐ 1,883 | 🐛 18 | 🌐 Python | 📅 2024-02-20 - Performs MiTM for IPv6.
...
* [netprobify](https://github.com/criteo/netprobify) ⭐ 37 | 🐛 0 | 🌐 Python | 📅 2025-08-18 - Network probing tool crafted for datacenters (but not only). Probing using: TCP, UDP or ICMP.
...
* [Cotopaxi](https://github.com/Samsung/cotopaxi) ⭐ 359 | 🐛 1 | 🌐 Python | 📅 2024-05-31 - Set of tools for security testing of Internet of Things devices using specific network IoT protocols (AMQP, CoAP, DTLS, HTCPCP, KNX, mDNS, MQTT, MQTT-SN, QUIC, RTSP, SSDP) .
...
* [Linux Kernel](https://github.com/torvalds/linux/blob/master/tools/testing/selftests/tc-testing/plugin-lib/scapyPlugin.py) ⭐ 216,519 | 🐛 3 | 🌐 C | 📅 2026-02-06 - Linux Traffic Control (tc) testing suite.
* [RIOT-OS](https://github.com/RIOT-OS/RIOT/search?l=Python\&q=scapy\&type=Code) ⭐ 5,678 | 🐛 835 | 🌐 C | 📅 2026-02-07 - RIOT OS networking testing suite.
...
* [TIDoS Framework](https://github.com/0xInfection/TIDoS-Framework) ⭐ 1,849 | 🐛 16 | 🌐 Python | 📅 2023-04-19 - The Offensive Manual Web Application Penetration Testing Framework.
...
* [Habu](https://github.com/fportantier/habu) ⭐ 972 | 🐛 2 | 🌐 Python | 📅 2025-12-30 - Toolkit with a lot of little hacking tools. Many of them use Scapy.
...
* [h2spacex](https://github.com/nxenon/h2spacex) ⭐ 212 | 🐛 2 | 🌐 Python | 📅 2026-01-30 - HTTP/2 low level library based on Scapy which can be used for Single Packet Attack (Race Condition on H2).
...
* [PPPwn (CVE-2006-4304)](https://github.com/TheOfficialFloW/PPPwn) ⭐ 2,905 | 🐛 12 | 🌐 Python | 📅 2024-06-16 - Playstation 4 PPPoE RCE.
...
* [fragattacks](https://github.com/vanhoefm/fragattacks) ⭐ 1,283 | 🐛 2 | 🌐 C | 📅 2025-04-29 - Fragmentation & Aggregation Attacks.
...
* [CVE-2018-4407](https://github.com/r3dxpl0it/CVE-2018-4407) ⭐ 34 | 🐛 0 | 🌐 Python | 📅 2018-11-04 - A heap buffer overflow in the networking code in the XNU operating system kernel (iOS and macOS).

2017

* [krackattacks-scripts](https://github.com/vanhoefm/krackattacks-scripts) ⭐ 3,486 | 🐛 5 | 🌐 C | 📅 2024-12-25 - Test if clients or access points (APs) are affected by the KRACK attack against WPA2.

2016

* [CVE-2016-6366](https://github.com/RiskSense-Ops/CVE-2016-6366) ⭐ 163 | 🐛 3 | 🌐 Python | 📅 2016-11-02 - The EXTRABACON exploit, a remote code execution for Cisco ASA written by the Equation Group (NSA) and leaked by the Shadow Brokers.
