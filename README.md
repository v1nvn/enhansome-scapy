...
* [pwnagotchi](https://github.com/evilsocket/pwnagotchi) ⭐ 9,096 | 🐛 295 | 🌐 Python | 📅 2025-08-23 - Your AI pet that hacks WiFI to grow. It's super cute.

DDoS

* [ufonet](https://github.com/epsylon/ufonet) ⭐ 2,471 | 🐛 0 | 🌐 Python | 📅 2026-05-28 - Create your own botnet to send untraceable DDoS attacks.

Wi-Fi.

* [wifiphisher](https://github.com/wifiphisher/wifiphisher) ⭐ 14,611 | 🐛 350 | 🌐 Python | 📅 2026-05-22 - Create rogue access point.
* [trackerjacker](https://github.com/calebmadrigal/trackerjacker) ⭐ 2,733 | 🐛 18 | 🌐 Python | 📅 2026-03-22 - Maps and tracks Wi-Fi networks and devices through raw 802.11 monitoring.

Wireless

* [WHAD](https://github.com/whad-team/whad-client) ⭐ 306 | 🐛 72 | 🌐 Python | 📅 2026-06-01 - A powerful framework to perform various kinds of Wireless attacks.

IPv6

* [mitm6](https://github.com/fox-it/mitm6) ⭐ 1,911 | 🐛 17 | 🌐 Python | 📅 2024-02-20 - Performs MiTM for IPv6.
* [Chiron](https://github.com/aatlasis/Chiron) ⭐ 211 | 🐛 1 | 🌐 Python | 📅 2018-11-16 - An IPv6 security assessment framework.

Measurements

* [mtraceroute](https://github.com/rwhalb/mtraceroute) ⭐ 70 | 🐛 1 | 🌐 Python | 📅 2023-03-06 - Create cool graphs over multiple traceroute analysis.
...
* [Linux Kernel](https://github.com/torvalds/linux/blob/master/tools/testing/selftests/tc-testing/plugin-lib/scapyPlugin.py) ⭐ 235,090 | 🐛 3 | 🌐 C | 📅 2026-06-02 - Linux Traffic Control (tc) testing suite.
* [RIOT-OS](https://github.com/RIOT-OS/RIOT/search?l=Python\&q=scapy\&type=Code) ⭐ 5,727 | 🐛 834 | 🌐 C | 📅 2026-05-31 - RIOT OS networking testing suite.
...
* [TIDoS Framework](https://github.com/0xInfection/TIDoS-Framework) ⭐ 1,861 | 🐛 16 | 🌐 Python | 📅 2023-04-19 - The Offensive Manual Web Application Penetration Testing Framework.
* [net-creds](https://github.com/DanMcInerney/net-creds) ⭐ 1,841 | 🐛 8 | 🌐 Python | 📅 2023-11-02 - Sniff and catch all sensitive data on an interface.
* [Habu](https://github.com/fportantier/habu) ⭐ 979 | 🐛 2 | 🌐 Python | 📅 2025-12-30 - Toolkit with a lot of little hacking tools. Many of them use Scapy.
* [pysap](https://github.com/SecureAuthCorp/pysap) ⭐ 250 | 🐛 3 | 🌐 Python | 📅 2026-06-01 - Interact with SAP using custom built frames & tools.
* [fenrir](https://github.com/Orange-Cyberdefense/fenrir-ocd) ⭐ 239 | 🐛 7 | 🌐 Python | 📅 2020-10-08 - Bypass wired 802.1x protection.
* [h2spacex](https://github.com/nxenon/h2spacex) ⭐ 224 | 🐛 1 | 🌐 Python | 📅 2026-04-24 - HTTP/2 low level library based on Scapy which can be used for Single Packet Attack (Race Condition on H2).
...
* [PPPwn (CVE-2006-4304)](https://github.com/TheOfficialFloW/PPPwn) ⭐ 2,944 | 🐛 12 | 🌐 Python | 📅 2024-06-16 - Playstation 4 PPPoE RCE.
...
* [fragattacks](https://github.com/vanhoefm/fragattacks) ⭐ 1,297 | 🐛 2 | 🌐 C | 📅 2025-04-29 - Fragmentation & Aggregation Attacks.
...
* [krackattacks-scripts](https://github.com/vanhoefm/krackattacks-scripts) ⭐ 3,509 | 🐛 5 | 🌐 C | 📅 2024-12-25 - Test if clients or access points (APs) are affected by the KRACK attack against WPA2.
